      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-start">
          ...
          <div className="w-full lg:w-1/2">
            ...
            {/* Pill Badge */}
            <div className="bg-white rounded-[20px] shadow-sm inline-flex flex-col p-4 px-5 mb-10">
            ...
            {/* Heading */}
            <h2 className="text-4xl md:text-5xl font-medium text-[#111111] leading-tight mb-10">
          ...
          {/* Right Column (Form) */}
          <div className="w-full lg:w-1/2">
            <div className="bg-white rounded-xl p-6 md:p-8 w-full lg:w-[90%] ml-auto">
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" className="w-full border border-gray-100 rounded-md px-4 py-2.5 focus:outline-none focus:border-primary transition-colors text-[15px]" />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="email" className="w-full border border-gray-100 rounded-md px-4 py-2.5 focus:outline-none focus:border-primary transition-colors text-[15px]" />
                  </div>
                  <div>
                    <label className="block text-primary font-medium text-[15px] mb-2">Phone Number</label>
                    <div className="flex items-center border border-gray-100 rounded-md px-4 py-2.5 bg-white focus-within:border-primary transition-colors">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select className="w-full border border-gray-100 rounded-md px-4 py-2.5 appearance-none focus:outline-none focus:border-primary transition-colors text-gray-700 text-[15px] bg-white cursor-pointer">
                ...
                <div>
                  ...
                  <textarea rows="3" className="w-full border border-gray-100 rounded-md px-4 py-2.5 focus:outline-none focus:border-primary transition-colors resize-none text-[15px]"></textarea>
                </div>

                {/* Submit Button */}
                <button type="button" className="w-full bg-[#116e63] hover:bg-[#0e5c53] text-white font-medium text-[16px] py-4 rounded-full transition-colors mt-4">
                  Send Message
                </button>
              </form>
            </div>
